...
with col2:
    if st.button("Vider le panier", disabled=len(st.session_state.panier)==0):
...
if st.button("PAYER MAINTENANT", type="primary", disabled=total==0):
    try:
        session = stripe.checkout.Session.create(
            ...
            mode='payment',
            success_url='https://meubles-bois-cameroun.streamlit.app?success=true',
            cancel_url='https://meubles-bois-cameroun.streamlit.app',
        )
